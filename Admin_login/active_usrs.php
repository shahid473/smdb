                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tile_news">
                                    <h3 class="tile-title pull-left">Active Users</h3>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td data-label="Details">
                                                        <a href="user_profile.html" class="btn btn-outline-primary ">
            ...
            <section>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="copyright">
                                <p>Copyright © 2020 Live Horizon. All rights reserved. Designed by <a
                                        href="https://www.siyasheshagalaxy.co.za">siyasheshagalaxy.co.za</a>.</p>
                            </div>
                        </div>
                    </div>
                </div>
