                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="tile_news">
                                    <h3 class="tile-title pull-left">Email Unverified User List</h3>
                                    <div class="m-auto icon-btn py-2">
                                        <form method="POST" class="form-inline" action="">
                                            <input type="hidden" name="_token" value="wXdEupzYkXWY5doFpU2KhB8TwnlaYqy17ry55lNS">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td data-label="Mobile">+88018544777</td>
