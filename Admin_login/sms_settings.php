                                        ...
                                        <form role="form" method="POST" action="">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <input type="text" name="smsapi" id="smsapi" class="form-control" value="https://api.infobip.com/api/v3/sendsms/plain?user=****&amp;password=*****&amp;sender=Sender&amp;SMSText={{message}}&amp;GSM={{number}}&amp;type=longSMS">
                                                </div>
                                            </div>
